...
INDEX_HTML += myVariable;
INDEX_HTML +="Channel 1\"); $(\"#chn-2-name\").text(\"";
INDEX_HTML += myVariable;
INDEX_HTML +="Channel 2\"); $(\"#chn-3-name\").text(\"";
INDEX_HTML += myVariable;
INDEX_HTML +="Channel 3\"); $(\"#chn-4-name\").text(\"";
INDEX_HTML += myVariable;
INDEX_HTML +="Channel 4\"); $(\"#chn-1-timer\").text(\"";
INDEX_HTML += myVariable;
INDEX_HTML +="5 min\"); $(\"#chn-2-timer\").text(\"";
INDEX_HTML += myVariable;
INDEX_HTML +="5 sec\"); $(\"#chn-3-timer\").text(\"";
INDEX_HTML += myVariable;
INDEX_HTML +="5 min\"); $(\"#chn-4-timer\").text(\"";
INDEX_HTML += myVariable;
INDEX_HTML +="5 sec\"); $(\"#chn-1-time\").text(\"";
INDEX_HTML += myVariable;
...
int   channelTimers[4]; //timer in Mins

//Wifi Settings
 String wifiMode="AP";
 char ssid[]="GC-Automation";
 String security="WPA";
